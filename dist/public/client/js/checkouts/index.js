...
const main = () => {
  ...
  btnSubmit.addEventListener("click", () => {
    ...
    const city = document.querySelector("sl-select[id='city']");
    const district = document.querySelector("sl-select[id='district']");
    const ward = document.querySelector("sl-select[id='ward']");
