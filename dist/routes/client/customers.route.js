...
const customers_validate_1 = require("../../validation/client/customers.validate");
...
router.post(`${index_routes_1.default.CLIENT.CUSTOMER.REGISTER}`, customers_validate_1.register, controller.registerPost);
router.post(`${index_routes_1.default.CLIENT.CUSTOMER.LOGIN}`, customers_validate_1.login, controller.loginPost);
