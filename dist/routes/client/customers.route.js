...
router.post(`${index_routes_1.default.CLIENT.CUSTOMER.INFOR_CUSTOMER}${index_routes_1.default.CLIENT.CUSTOMER.INFOR_CUSTOMER_UPDATE_INFOR}${index_routes_1.default.CLIENT.CUSTOMER.INFOR_CUSTOMER_UPDATE_EMAIL}`, CustomerValidate.infoCustomerUpdateEmailPost, controller.infoCustomerUpdateEmailPost);
...
router.post(`${index_routes_1.default.CLIENT.CUSTOMER.INFOR_CUSTOMER}${index_routes_1.default.CLIENT.CUSTOMER.INFOR_CUSTOMER_UPDATE_INFOR}${index_routes_1.default.CLIENT.CUSTOMER.INFOR_CUSTOMER_UPDATE_PHONE}`, CustomerValidate.infoCustomerUpdatePhonePost, controller.infoCustomerUpdatePhonePost);
...
router.patch(`${index_routes_1.default.CLIENT.CUSTOMER.INFOR_CUSTOMER}${index_routes_1.default.CLIENT.CUSTOMER.INFOR_CUSTOMER_UPDATE_INFOR}${index_routes_1.default.CLIENT.CUSTOMER.INFOR_CUSTOMER_UPDATE_PASSWORD}`, CustomerValidate.infoCustomerUpdatePassword, controller.infoCustomerUpdatePassword);
