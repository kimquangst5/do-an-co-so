...
const reviews_validate_1 = require("../../validation/client/reviews.validate");
...
router.post(`${index_routes_1.default.CLIENT.PRODUCT.DETAIL}/:id${index_routes_1.default.CLIENT.CUSTOMER.REVIEW}`, reviews_validate_1.review, controller.review);
